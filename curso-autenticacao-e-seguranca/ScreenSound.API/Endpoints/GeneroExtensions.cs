...
public static class GeneroExtensions
{
    ...
    public static void AddEndPointGeneros(this WebApplication app)
    {
        ...
        groupBuilder.MapGet("/Generos", ([FromServices] DAL<Genero> dal) =>
        {
            return EntityListToResponseList(dal.Listar());
        });

        groupBuilder.MapGet("/Generos/{nome}", ([FromServices] DAL<Genero> dal, string nome) =>
        {
        ...
        groupBuilder.MapDelete("/Generos/{id}", ([FromServices] DAL<Genero> dal, int id) =>
        {

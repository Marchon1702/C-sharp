...
{ 
    public static void AddEndPointsMusicas(this WebApplication app)
    {
        ...
        groupBuilder.MapGet("/Musicas", ([FromServices] DAL<Musica> dal) =>
        {
        ...
        groupBuilder.MapGet("/Musicas/{nome}", ([FromServices] DAL<Musica> dal, string nome) =>
        {
        ...
        groupBuilder.MapPost("/Musicas", ([FromServices] DAL<Musica> dal, [FromServices] DAL<Genero> dalGenero,[FromBody] MusicaRequest musicaRequest) =>
        {
        ...
        groupBuilder.MapDelete("/Musicas/{id}", ([FromServices] DAL<Musica> dal, int id) => {
        ...
        groupBuilder.MapPut("/Musicas", ([FromServices] DAL<Musica> dal, [FromBody] MusicaRequestEdit musicaRequestEdit) => {
